...
## Data Visualisations
To present the data I created 2 graphs; I created a scatter plot to visualise the average petrol tax based on income. The second is a horizontal bar chart which visualises the number of paved highways based on cities in the UK. It illustrated that Salford had the highest amount of paved highways in the UK.

![](https://github.com/angongcelenica/Modelling-Data/blob/main/graphs/avgincomepetrol.png)
![](https://github.com/angongcelenica/Modelling-Data/blob/main/graphs/paved_highways_petrol.png)
